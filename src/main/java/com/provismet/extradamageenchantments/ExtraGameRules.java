...
public class ExtraGameRules {
    public static final GameRules.Key<DoubleRule> PLAYER_ENCHANTMENT_DAMAGE_MOD = GameRuleRegistry.register("damageEnchantAgainstPlayerEffectiveness", CPCGameRules.CATEGORY, GameRuleFactory.createDoubleRule(0.5, 0.0));
